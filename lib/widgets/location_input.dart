...
class _LocationInputState extends State<LocationInput> {
  ...
  Widget build(BuildContext context) {
    Widget previewContent = Text(
      AppLocalizations.of(context)!.location_noLocationChosen,
        ...
        Row(
          ...
          children: [
            TextButton.icon(
              ...
              label: Text(
                  AppLocalizations.of(context)!.location_getCurrentLocation),
              onPressed: _getCurrentLocation,
            ),
            TextButton.icon(
              icon: const Icon(Icons.map),
              label: Text(AppLocalizations.of(context)!.location_selectOnMap),
